...
import { Eye, EyeOff, Mail, Lock, Loader2, Shield, Smartphone, Users, Target, DollarSign, BarChart3, Megaphone, TrendingUp, ArrowUpRight, Facebook, Instagram, Youtube, Music, Twitter, MessageCircle as Telegram, Gamepad2, Linkedin } from 'lucide-react';
...
const features = [
  { icon: <Megaphone className="h-5 w-5" />, text: 'Campaign Analytics' },
  { icon: <Target className="h-5 w-5" />, text: 'Targeted Reach' },
  { icon: <BarChart3 className="h-5 w-5" />, text: 'Real Reports' },
  { icon: <TrendingUp className="h-5 w-5" />, text: 'Brand Growth' },
  { icon: <Users className="h-5 w-5" />, text: 'Real Users' },
  { icon: <DollarSign className="h-5 w-5" />, text: 'Budget Control' },
];
      ...
      <div className="hidden lg:flex lg:w-[60%] relative overflow-hidden flex-col justify-between p-12" style={{ background: 'linear-gradient(135deg, #0F172A 0%, #1a2744 40%, #1E8A8D 70%, #18C97A 100%)' }}>
        ...
        <div className="relative z-10 max-w-xl">
          <h1 className="font-heading text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight mb-6">
            ...
            <span className="gradient-primary-text">Reach Real Users.</span><br />
            Grow Your Business.
          </h1>
          <p className="text-lg text-gray-300 mb-8">Create campaigns that generate real engagement from thousands of active users worldwide.</p>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-[20px] shadow-2xl shadow-blue-900/10 border border-gray-100 p-8 lg:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500">Login to manage your campaigns.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input type="email" placeholder="Enter your email" value={email} onChange={(e) => setEmail(e.target.value)} required className="w-full h-14 pl-12 pr-4 rounded-xl border border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-sm" />
                </div>
              </div>
              ...
              <button type="submit" disabled={loading} className="relative w-full h-14 rounded-xl font-semibold text-white text-base overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-blue-900/20 disabled:opacity-70" style={{ background: 'linear-gradient(135deg, #2D4F97, #18C97A)' }}>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-500">
                ...
                <Link href="/register?role=advertiser" className="font-semibold gradient-primary-text hover:opacity-80 transition-opacity">
